...
tx_bb_entrepreneur_merged_v2 <- tx_bb_entrepreneur_merged_v2 %>% 
  ...
  mutate(pct_broadband_MS_nov_2019 = case_when(is.na(pct_broadband_MS_nov_2019) ~ 0, TRUE ~ pct_broadband_MS_nov_2019),
         ...
         nonfarmprop_percapita = nonfarmproprietors_bea_2019 / population_2018,
         est_10_cbp_percapita = est_10_cbp_2019 / population_2018,
         est_50_cbp_percapita = est_50_cbp_2019 / population_2018)
