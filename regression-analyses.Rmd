...
stargazer(model_vd_2.1, model_vd_2.2, model_vd_2.3, model_vd_2.4, type = "html", align = T,
          ...
          covariate.labels = c("Nonfarm Proprietor (%)",
                               ...
                               "Other occupation (% of workers)","Public (% of workers)","Highschool Level Education","College Level Education","Millenials","GenX","Babyboomer"),
          no.space = T)
