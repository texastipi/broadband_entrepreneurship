...
tx_bb_entrepreneur_merged_v2 <- read.csv("https://raw.githubusercontent.com/texastipi/broadband_entrepreneurship/master/Broadband-Entrepreneurship-TXKSME.csv")
...
```{r Distributions of Broadband Measures, echo=FALSE, message=FALSE, fig.retina=2, fig.dim=c(10,7)}
grid.arrange(
...
```{r Correlations b/w Broadband Measures, echo=FALSE, message=FALSE, fig.retina=2, fig.dim=c(10,7)}
grid.arrange(
