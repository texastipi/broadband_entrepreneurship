...
stargazer(as.data.frame(tx_bb_entrepreneur_merged_v2)[c("pct_bb_fcc_2019","pct_broadband_MS","pct_fixed_acs_2018","pct_broadband_mlab")],
...
#### Descriptive Statistics ####
stargazer(as.data.frame(me_bb_entrepreneur_merged_v2)[c("pct_bb_fcc_2019","pct_broadband_MS","pct_fixed_acs_2018","pct_broadband_mlab")],
          covariate.labels = c("FCC Broadband Availability (25/3 Mbps)","Microsoft Broadband (25/3)","ACS Fixed Subscription Level","M-Lab Broadband Test (25/3)"), type = "html",
          align = TRUE, font.size = "Huge", column.sep.width = "2pt")
```
...
#### Descriptive Statistics ####
stargazer(as.data.frame(ks_bb_entrepreneur_merged_v2)[c("pct_bb_fcc_2019","pct_broadband_MS","pct_fixed_acs_2018","pct_broadband_mlab")],
          covariate.labels = c("FCC Broadband Availability (25/3 Mbps)","Microsoft Broadband (25/3)","ACS Fixed Subscription Level","M-Lab Broadband Test (25/3)"), type = "html",
          align = TRUE, font.size = "Huge", column.sep.width = "2pt")
```
...
grid.arrange(
  ggplot(tx_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019)) + 
...
grid.arrange(
  ggplot(me_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019)) + 
    geom_histogram() + theme_minimal() + 
    theme(axis.text = element_text(size = 11),
          axis.title = element_text(size = 12, face = "bold")) + 
    xlab("FCC Broadband") + ylab("Frequency") +
...
grid.arrange(
  ggplot(ks_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019)) + 
    geom_histogram() + theme_minimal() + 
    theme(axis.text = element_text(size = 11),
          axis.title = element_text(size = 12, face = "bold")) + 
    xlab("FCC Broadband") + ylab("Frequency") +
...
grid.arrange(
  ggplot(tx_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019, y = pct_broadband_MS)) + 
  ...
  ggplot(tx_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019, y = pct_fixed_acs_2018)) +
    geom_point(color = "grey10", alpha = 0.7, size = 3) + 
    geom_smooth(method = "lm", color = "darkorange3") + theme_minimal() +
    theme(axis.text = element_text(size = 11), axis.title = element_text(size = 12, face = "bold")) +
    ...
    scale_y_continuous(labels = scales::percent, breaks = scales::breaks_pretty()) +
    ggpubr::stat_cor(p.accuracy = 0.001, r.accuracy = 0.01),
  ggplot(tx_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019, y = pct_broadband_mlab)) +
    geom_point(color = "grey10", alpha = 0.7, size = 3) + 
    geom_smooth(method = "lm", color = "darkorange3") + theme_minimal() +
    theme(axis.text = element_text(size = 11), axis.title = element_text(size = 12, face = "bold")) +
...
grid.arrange(
  ggplot(me_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019, y = pct_broadband_MS)) + 
    geom_point(color = "grey10", alpha = 0.7, size = 3) + 
    geom_smooth(method = "lm", color = "darkorange3") + theme_minimal() + 
    theme(axis.text = element_text(size = 11), axis.title = element_text(size = 12, face = "bold")) +
    labs(x = "FCC Broadband", y = "Microsoft Broadband") +
    ...
    scale_y_continuous(labels = scales::percent, breaks = scales::breaks_pretty()) +
    ggpubr::stat_cor(p.accuracy = 0.001, r.accuracy = 0.01),
  ggplot(me_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019, y = pct_fixed_acs_2018)) +
    geom_point(color = "grey10", alpha = 0.7, size = 3) + 
    geom_smooth(method = "lm", color = "darkorange3") + theme_minimal() +
    theme(axis.text = element_text(size = 11), axis.title = element_text(size = 12, face = "bold")) +
    labs(x = "FCC Broadband", y = "ACS Fixed BB Subscription") +
    ...
    scale_y_continuous(labels = scales::percent, breaks = scales::breaks_pretty()) +
    ggpubr::stat_cor(p.accuracy = 0.001, r.accuracy = 0.01),
  ggplot(me_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019, y = pct_broadband_mlab)) +
    geom_point(color = "grey10", alpha = 0.7, size = 3) + 
    geom_smooth(method = "lm", color = "darkorange3") + theme_minimal() +
    theme(axis.text = element_text(size = 11), axis.title = element_text(size = 12, face = "bold")) +
    labs(y = "M-Lab Broadband", x = "FCC Broadband") +
...
grid.arrange(
  ggplot(ks_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019, y = pct_broadband_MS)) + 
    geom_point(color = "grey10", alpha = 0.7, size = 3) + 
    geom_smooth(method = "lm", color = "darkorange3") + theme_minimal() + 
    theme(axis.text = element_text(size = 11), axis.title = element_text(size = 12, face = "bold")) +
    labs(x = "FCC Broadband", y = "Microsoft Broadband") +
    ...
    scale_y_continuous(labels = scales::percent, breaks = scales::breaks_pretty()) +
    ggpubr::stat_cor(p.accuracy = 0.001, r.accuracy = 0.01),
  ggplot(ks_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019, y = pct_fixed_acs_2018)) +
    geom_point(color = "grey10", alpha = 0.7, size = 3) + 
    geom_smooth(method = "lm", color = "darkorange3") + theme_minimal() +
    theme(axis.text = element_text(size = 11), axis.title = element_text(size = 12, face = "bold")) +
    labs(x = "FCC Broadband", y = "ACS Fixed BB Subscription") +
    ...
    scale_y_continuous(labels = scales::percent, breaks = scales::breaks_pretty()) +
    ggpubr::stat_cor(p.accuracy = 0.001, r.accuracy = 0.01),
  ggplot(ks_bb_entrepreneur_merged_v2, aes(x = pct_bb_fcc_2019, y = pct_broadband_mlab)) +
    geom_point(color = "grey10", alpha = 0.7, size = 3) + 
    geom_smooth(method = "lm", color = "darkorange3") + theme_minimal() +
    theme(axis.text = element_text(size = 11), axis.title = element_text(size = 12, face = "bold")) +
    labs(y = "M-Lab Broadband", x = "FCC Broadband") +
...
pal <- colorNumeric(palette = "YlOrRd", domain = tx_bb_entrepreneur_merged_v2$pct_bb_fcc_2019)
## Set a popup template ##
# Texas
popup_tx <- paste0("<strong>", tx_bb_entrepreneur_merged_v3$county,
                   "</strong><br />FCC: ", tx_bb_entrepreneur_merged_v3$pct_bb_fcc_2019*100, "%",
...
popup_me <- paste0("<strong>", me_bb_entrepreneur_merged_v3$county,
                   "</strong><br />FCC: ", me_bb_entrepreneur_merged_v3$pct_bb_fcc_2019*100, "%",
...
popup_ks <- paste0("<strong>", ks_bb_entrepreneur_merged_v3$county,
                   "</strong><br />FCC: ", ks_bb_entrepreneur_merged_v3$pct_bb_fcc_2019*100, "%",
