...
acs_demo <- getCensus(name = "acs/acs5/profile", vintage = 2019,
                      vars = c("DP02_0067PE","DP02_0068PE","DP02_0066PE", # Educational attainment
                               ...
                               "B06011_001E"), # Total household median income
                      region = "county:*",
                      regionin = "state:20,23,48")
...
demo_cont <- acs_demo %>% 
  ...
  mutate(county_FIPS = paste0(state, county),
         ...
         med_income_2019 = med_income_2019/1000) %>% 
...
library(tidycensus)
census_api_key("9001b546c2d77876a089119664dc25a4235eea37", install = TRUE)
```
