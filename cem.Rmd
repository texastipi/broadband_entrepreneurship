...
popcut <- hist(d2$LNpop_2018, br=seq(min(d2$LNpop_2018, na.rm = T), max(d2$LNpop_2018, na.rm = T), length.out = 5), plot = F)$breaks

indstrycut <- hist(d2$indstry_diversity, br=seq(min(d2$indstry_diversity), max(d2$indstry_diversity), length.out = 5), plot = F)$breaks

educut <- hist(d2$pctbachelors_2018, br=seq(min(d2$pctbachelors_2018), max(d2$pctbachelors_2018), length.out = 5), plot = F)$breaks

unempcut <- hist(d2$pct_unemployment_2018, br=seq(min(d2$pct_unemployment_2018), max(d2$pct_unemployment_2018), length.out = 5), plot = F)$breaks

# Ruralities
irrcut <- hist(d2$IRR2010, br = seq(min(d2$IRR2010), max(d2$IRR2010), length.out = 5), plot = F)$breaks


mycp <- list(LNpop_2018 = popcut, indstry_diversity = indstrycut, pctbachelors_2018 = educut, pct_unemployment_2018 = unempcut, IRR2010 = irrcut)

## List of covariates
vars <- c("LNpop_2018", "indstry_diversity", "pctbachelors_2018", "pct_unemployment_2018", "IRR2010")

droplst <- c("pct_nonfarm_bea_2018", "vd_mean_20", "havd_mean_20", "nonfarmprop_percapita", "metro_f")

#### Treatment: BB_25_3_high ####

d25_3 <- d2 %>% select(BB_25_3_high,
                    pct_nonfarm_bea_2018, vd_mean_20, havd_mean_20, nonfarmprop_percapita,
                    LNpop_2018, indstry_diversity, pctbachelors_2018, pct_unemployment_2018, IRR2010, metro_f)
...
mod_25_3_nonfarm <- att(match_fcc_25_3, pct_nonfarm_bea_2018 ~ BB_25_3_high, data = d25_3)
...
mod_100_10_nonfarm <- att(match_fcc_100_10, pct_nonfarm_bea_2018 ~ BB_100_10_high, data = d100_10)
...
mod_250_25_nonfarm <- att(match_fcc_250_25, pct_nonfarm_bea_2018 ~ BB_250_25_high, data = d250_25)
...
mod_1000_100_nonfarm <- att(match_fcc_1000_100, pct_nonfarm_bea_2018 ~ BB_1000_100_high, data = d1000_100)
...
mod_adoption_nonfarm <- att(match_fcc_adoption, pct_nonfarm_bea_2018 ~ BB_adoption_high, data = dadoption)
...
mod_qos_nonfarm <- att(match_fcc_qos, pct_nonfarm_bea_2018 ~ BB_qos_high, data = dqos)
